...
// Edit JSON modal
this.editjson_holder=this.theme.getModal(),this.editjson_action_content=this.theme.getModalActionContent(),this.editjson_textarea=this.theme.getJsonEditorTextareaInput(),this.editjson_save=this.getButton("Save","save","Save"),this.editjson_save.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.saveJSON()}),this.editjson_cancel=this.getButton("Cancel","cancel","Cancel"),this.editjson_cancel.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.hideEditJSON()}),this.editjson_action_content.appendChild(this.editjson_save),this.editjson_action_content.appendChild(this.editjson_cancel),this.editjson_holder.appendChild(this.editjson_textarea),this.editjson_holder.appendChild(this.editjson_action_content),
// Manage Properties modal
this.addproperty_holder=this.theme.getModal(),this.addproperty_list=this.theme.getModalList(),this.addproperty_action_content=this.theme.getModalActionContent(),this.addproperty_add=this.getButton("add","add","add"),this.addproperty_input=this.theme.getPropertyNameInputField(),this.addproperty_input.setAttribute("placeholder","Property name..."),this.addproperty_add.addEventListener("click",function(b){if(b.preventDefault(),b.stopPropagation(),a.addproperty_input.value){if(a.editors[a.addproperty_input.value])return void window.alert("there is already a property with that name");a.addObjectProperty(a.addproperty_input.value),a.editors[a.addproperty_input.value]&&a.editors[a.addproperty_input.value].disable(),a.onChange(!0)}}),this.addproperty_action_content.appendChild(this.addproperty_input),this.addproperty_action_content.appendChild(this.addproperty_add),this.addproperty_holder.appendChild(this.addproperty_list),this.addproperty_holder.appendChild(this.addproperty_action_content);var b=document.createElement("div");b.style.clear="both",this.addproperty_holder.appendChild(b),
// Description
