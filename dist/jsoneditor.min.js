...
var e={};return d(b,function(a,d){e[d]=e[d]||0,e[d]++,c[d]>1&&(b[a]=d+" "+e[d])}),b},getOption:function(a){try{throw"getOption is deprecated"}catch(b){window.console.error(b)}return this.options[a]},showValidationErrors:function(a){},/* Setup materialize plugin */
setupMaterialize:function(a){window.jQuery&&f.plugins.materialize.enable&&(window.$(a).material_select("destroy"),window.$(a).material_select())}}),f.defaults.editors["null"]=f.AbstractEditor.extend({getValue:function(){return null},setValue:function(){this.onChange()},getNumColumns:function(){return 2}}),f.defaults.editors.string=f.AbstractEditor.extend({register:function(){this._super(),this.input&&this.input.setAttribute("name",this.formname)},unregister:function(){this._super(),this.input&&this.input.removeAttribute("name")},setValue:function(a,b,c){var d=this;if((!this.template||c)&&(null===a||"undefined"==typeof a?a="":"object"==typeof a?a=JSON.stringify(a):"string"!=typeof a&&(a=""+a),a!==this.serialized)){
// Sanitize value before setting it
var e=this.sanitize(a);if(this.input.value!==e){this.input.value=e,
// If using SCEditor, update the WYSIWYG
this.sceditor_instance?this.sceditor_instance.val(e):this.epiceditor?this.epiceditor.importFile(null,e):this.ace_editor&&this.ace_editor.setValue(e);var f=c||this.getValue()!==a;this.refreshValue(),b?this.is_dirty=!1:"change"===this.jsoneditor.options.show_errors&&(this.is_dirty=!0),this.adjust_height&&this.adjust_height(this.input),
// Bubble this setValue to parents if the value changed
this.onChange(f),f&&d.theme.enableLabel(d.label)}}},getNumColumns:function(){var a,b=Math.ceil(Math.max(this.getTitle().length,this.schema.maxLength||0,this.schema.minLength||0)/5);return a="textarea"===this.input_type?6:["text","email"].indexOf(this.input_type)>=0?4:2,Math.min(12,Math.max(b,a))},build:function(){var a=this;
// Specific format
...
// Edit JSON modal
this.editjson_holder=this.theme.getModal(),this.editjson_action_content=this.theme.getModalActionContent(),this.editjson_textarea=this.theme.getJsonEditorTextareaInput();var b=this.translate("button_save");this.editjson_save=this.getButton(b,"save",b),this.editjson_save.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.saveJSON()});var c=this.translate("button_cancel");this.editjson_cancel=this.getButton(c,"cancel",c),this.editjson_cancel.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.hideEditJSON()}),this.editjson_action_content.appendChild(this.editjson_save),this.editjson_action_content.appendChild(this.editjson_cancel),this.editjson_holder.appendChild(this.editjson_textarea),this.editjson_holder.appendChild(this.editjson_action_content),
// Manage Properties modal
this.addproperty_holder=this.theme.getModal(),this.addproperty_list=this.theme.getModalList(),this.addproperty_action_content=this.theme.getModalActionContent();var f=this.translate("button_add");this.addproperty_add=this.getButton(f,"add",f),this.addproperty_input=this.theme.getPropertyNameInputField(),this.addproperty_input.setAttribute("placeholder",this.translate("property_name")),this.addproperty_add.addEventListener("click",function(b){if(b.preventDefault(),b.stopPropagation(),a.addproperty_input.value){if(a.editors[a.addproperty_input.value])return void window.alert(a.translate("property_already_exist"));a.addObjectProperty(a.addproperty_input.value),a.editors[a.addproperty_input.value]&&a.editors[a.addproperty_input.value].disable(),a.onChange(!0)}}),this.addproperty_action_content.appendChild(this.addproperty_input),this.addproperty_action_content.appendChild(this.addproperty_add),this.addproperty_holder.appendChild(this.addproperty_list),this.addproperty_holder.appendChild(this.addproperty_action_content);var g=document.createElement("div");g.style.clear="both",this.addproperty_holder.appendChild(g),
// Description
...
// Edit JSON Button
this.editjson_button=this.getButton(this.translate("button_json"),"edit",this.translate("button_title_json")),this.editjson_button.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.toggleEditJSON()}),this.editjson_controls.appendChild(this.editjson_button),this.editjson_controls.appendChild(this.editjson_holder),
...
this.addproperty_button=this.getButton(this.translate("button_property"),"edit",this.translate("button_title_property")),this.addproperty_button.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.toggleAddProperty()}),this.addproperty_controls.appendChild(this.addproperty_button),this.addproperty_controls.appendChild(this.addproperty_holder),this.refreshAddProperties()}
...
var b=this.getElementEditor(0,!0);if(this.item_default=b.getDefault(),this.width=b.getNumColumns()+2,this.options.compact?(this.panel=document.createElement("div"),this.panel_content=document.createElement("div")):(this.header=document.createElement("span"),this.header.textContent=this.getTitle(),this.title=this.theme.getHeader(this.header),this.title_controls=this.theme.getHeaderButtonHolder(),this.title.appendChild(this.title_controls),this.container.appendChild(this.title),this.schema.description&&(this.description=this.theme.getDescription(this.schema.description),this.container.appendChild(this.description)),this.panel=this.theme.getIndentedPanel(),this.panel_content=this.theme.getGridContainer(),this.error_holder=document.createElement("div"),this.panel_content.appendChild(this.error_holder)),this.panel_content.appendChild(this.table),this.controls=this.theme.getTableControls(),this.panel_content.appendChild(this.controls),this.panel.appendChild(this.panel_content),this.container.appendChild(this.panel),this.item_has_child_editors)for(var c=b.getChildEditors(),d=b.property_order||Object.keys(c),e=0;e<d.length;e++){var f=a.theme.getTableHeaderCell(c[d[e]].getTitle());c[d[e]].options.hidden&&(f.style.display="none"),a.header_row.appendChild(f)}else a.header_row.appendChild(a.theme.getTableHeaderCell(this.item_title));b.destroy(),this.row_holder.innerHTML="",
// Row Controls column
...
this.schema.options&&"undefined"!=typeof this.schema.options.disable_collapse?this.schema.options.disable_collapse&&(this.toggle_button.style.display="none"):this.jsoneditor.options.disable_collapse&&(this.toggle_button.style.display="none")),
// Add "new row" and "delete last" buttons below editor
this.action_controls=this.theme.getTableControls(),this.add_row_button=this.getButton(this.getItemTitle(),"add",this.translate("button_add_row_title",[this.getItemTitle()])),this.theme.setTableButtonStyle(this.add_row_button),this.add_row_button.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.addRow(),a.refreshValue(),a.refreshRowButtons(),a.onChange(!0)}),this.action_controls.appendChild(this.add_row_button),this.delete_last_row_button=this.getButton(this.translate("button_delete_last",[this.getItemTitle()]),"delete",this.translate("button_delete_last_title",[this.getItemTitle()])),this.theme.setTableButtonStyle(this.delete_last_row_button),this.delete_last_row_button.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation();var c=a.getValue();c.pop(),a.setValue(c),a.onChange(!0)}),this.action_controls.appendChild(this.delete_last_row_button),this.remove_all_rows_button=this.getButton(this.translate("button_delete_all"),"delete",this.translate("button_delete_all_title")),this.theme.setTableButtonStyle(this.remove_all_rows_button),this.remove_all_rows_button.addEventListener("click",function(b){b.preventDefault(),b.stopPropagation(),a.setValue([]),a.onChange(!0)}),this.action_controls.appendChild(this.remove_all_rows_button),a.controls.appendChild(this.action_controls)}}),
...
// Sanitize value before setting it
var c=a;this.enum_values.indexOf(c)<0&&(c=this.enum_values[0]),this.value!==c&&(this.input.value=this.enum_options[this.enum_values.indexOf(c)],this.selectize&&this.selectize[0].selectize.addItem(c),this.value=c,this.onChange(),this.setupMaterialize(this.input))},register:function(){this._super(),this.input&&this.input.setAttribute("name",this.formname)},unregister:function(){this._super(),this.input&&this.input.removeAttribute("name")},getNumColumns:function(){if(!this.enum_options)return 3;for(var a=this.getTitle().length,b=0;b<this.enum_options.length;b++)a=Math.max(a,this.enum_options[b].length+4);return Math.min(12,Math.max(a/7,2))},typecast:function(a){return"boolean"===this.schema.type?!!a:"number"===this.schema.type?1*a:"integer"===this.schema.type?Math.floor(1*a):""+a},getValue:function(){return this.value},preBuild:function(){var a=this;this.input_type="select",this.enum_options=[],this.enum_values=[],this.enum_display=[];var b;
// Enum options enumerated
...
// File uploader
this.uploader=this.theme.getFormInputField("file"),this.uploader.addEventListener("change",function(b){if(a.theme.getProgressBar&&(a.progressBar=a.theme.getProgressBar(),a.wrapper.appendChild(a.progressBar)),this.files&&this.files.length){var c=new FileReader;c.onloadstart=function(b){a.updateProgress()},c.onload=function(b){a.onLoadFileReader(b),c=null},c.onloadend=function(b){a.updateProgress(100),setTimeout(function(){a.progressBar.remove()},200)},c.readAsDataURL(this.files[0])}})}this.preview=this.theme.getFileInputPreview(),this.information=this.theme.getFormInputDescription(this.schema.description),this.control=this.theme.getFormControl(this.label,this.uploader||this.input,this.preview),this.decorator=this.theme.getFileInputDecorator(),this.wrapper.appendChild(this.control),this.decorator&&(this.decorator.appendChild(this.preview),this.wrapper.appendChild(this.decorator)),this.information&&this.wrapper.appendChild(this.information),this.container.appendChild(this.wrapper)},refreshPreview:function(){if(this.last_preview!==this.value&&(this.last_preview=this.value,this.information.innerHTML="",this.value)){var a=this.value.match(/^data:([^;,]+)[;,]/);if(a&&(a=a[1]),a){if(this.information.innerHTML='<small class="previe-info"><strong>'+this.translate("type")+":</strong> "+a+", <strong>"+this.translate("size")+":</strong> "+Math.floor((this.value.length-this.value.split(",")[0].length-1)/1.33333)+" bytes","image"===a.substr(0,5)){var b=this.preview.getElementsByTagName("img")[0];b.setAttribute("src",this.value)}}else this.information.innerHTML="<em>"+this.translate("invalid_uri")+"</em>"}},enable:function(){this.uploader&&(this.uploader.disabled=!1),this._super()},disable:function(){this.uploader&&(this.uploader.disabled=!0),this._super()},setValue:function(a){this.value!==a&&(this.value=a,this.input.value=this.value,this.refreshPreview(),this.onChange())},destroy:function(){this.preview&&this.preview.parentNode&&this.preview.parentNode.removeChild(this.preview),this.title&&this.title.parentNode&&this.title.parentNode.removeChild(this.title),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this.uploader&&this.uploader.parentNode&&this.uploader.parentNode.removeChild(this.uploader),this._super()},onLoadFileReader:function(a){this.setValue(a.target.result),this.refreshPreview(),this.onChange(!0)},updateProgress:function(a){this.progressBar&&(a?this.theme.updateProgressBar(this.progressBar,a):this.theme.updateProgressBarUnknown(this.progressBar))}}),f.defaults.editors.upload=f.AbstractEditor.extend({getNumColumns:function(){return 4},build:function(){var a=this;
// Don't show uploader if this is readonly
if(this.wrapper=this.theme.getFileInputWrapper(),this.title=this.header=this.label=this.theme.getFileInputLabel(this.getTitle()),
// Input that holds the base64 string
...
// File uploader
this.uploader=this.theme.getFormInputField("file"),this.uploader.addEventListener("change",function(b){if(this.files&&this.files.length){var c=new FileReader;c.onload=function(b){a.onLoadFileReader(b),c=null},c.readAsDataURL(this.files[0])}else a.onLoadFileReader(b)})}var b=this.schema.description;b||(b=""),this.preview=this.theme.getFileInputPreview(),this.information=this.theme.getFormInputDescription(b),this.control=this.theme.getFormControl(this.label,this.uploader||this.input,this.preview),this.decorator=this.theme.getFileInputDecorator(),this.wrapper.appendChild(this.control),this.decorator&&(this.decorator.appendChild(this.preview),this.wrapper.appendChild(this.decorator)),this.information&&this.wrapper.appendChild(this.information),this.container.appendChild(this.wrapper)},refreshPreview:function(){if(this.last_preview!==this.preview_value){if(this.last_preview=this.preview_value,this.information.innerHTML="",this.decorator&&(this.decorator.className=this.decorator.className.replace(/\s?active/g,"")),!this.preview_value)return void this.setPreview();var a=this,b=this.preview_value.match(/^data:([^;,]+)[;,]/);b&&(b=b[1]),b||(b="unknown");var c=this.uploader.files[0];this.information.innerHTML='<small class="previe-info"><strong>'+this.translate("type")+":</strong> "+b+", <strong>"+this.translate("size")+":</strong> "+c.size+" bytes</small>","image"===b.substr(0,5)&&this.setPreview(),this.information.innerHTML+="<br>";var d=this.translate("button_upload"),e=this.getButton(d,"upload",d);this.information.appendChild(e),e.addEventListener("click",function(b){b.preventDefault(),e.setAttribute("disabled","disabled"),a.theme.removeInputError(a.uploader),a.theme.getProgressBar&&(a.progressBar=a.theme.getProgressBar(),a.preview.appendChild(a.progressBar)),a.jsoneditor.options.upload(a.path,c,{success:function(b){a.setValue(b),a.parent?a.parent.onChildEditorChange(a):a.jsoneditor.onChange(),a.progressBar&&a.preview.removeChild(a.progressBar)},failure:function(b){a.theme.addInputError(a.uploader,b),a.progressBar&&a.preview.removeChild(a.progressBar)},updateProgress:function(b){a.progressBar&&(b?a.theme.updateProgressBar(a.progressBar,b):a.theme.updateProgressBarUnknown(a.progressBar))}})});var f=this.getButton("","clean_upload");this.information.appendChild(f),f.addEventListener("click",function(b){b.preventDefault(),a.setValue(""),a.uploader.value="",a.uploader.dispatchEvent(new Event("change"))}),this.decorator&&this.decorator.className.indexOf("active")==-1&&(this.decorator.className+=" active")}},enable:function(){this.uploader&&(this.uploader.disabled=!1),this._super()},disable:function(){this.uploader&&(this.uploader.disabled=!0),this._super()},setValue:function(a){var b=this.value!==a;this.value=a,this.input.value=this.value,this.decorator&&(this.decorator.firstChild.value=a?a.split("/").pop():""),this.value&&(this.preview_value=this.value,this.setPreview()),b&&this.onChange()},destroy:function(){this.preview&&this.preview.parentNode&&this.preview.parentNode.removeChild(this.preview),this.title&&this.title.parentNode&&this.title.parentNode.removeChild(this.title),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this.uploader&&this.uploader.parentNode&&this.uploader.parentNode.removeChild(this.uploader),this._super()},onLoadFileReader:function(a){this.preview_value=a.target.result,this.refreshPreview(),this.onChange(!0)},setPreview:function(){var a=this.preview.getElementsByTagName("a")[0],b=a.getElementsByTagName("img")[0],c=this.preview_value||"";b.setAttribute("src",c),this.theme.setFileInputPreviewTooltip(b,c),a.setAttribute("href",c)}}),f.defaults.editors.checkbox=f.AbstractEditor.extend({setValue:function(a,b){this.value=!!a,this.input.checked=this.value,this.onChange()},register:function(){this._super(),this.input&&this.input.setAttribute("name",this.formname)},unregister:function(){this._super(),this.input&&this.input.removeAttribute("name")},getNumColumns:function(){return Math.min(12,Math.max(this.getTitle().length/7,2))},build:function(){var a=this;this.options.compact||(this.label=this.header=this.theme.getCheckboxLabel(this.getTitle())),this.schema.description&&(this.description=this.theme.getFormInputDescription(this.schema.description)),this.options.compact&&(this.container.className+=" compact"),this.input=this.theme.getCheckbox(),this.control=this.theme.getFormControl(this.label,this.input,this.description),(this.schema.readOnly||this.schema.readonly)&&(this.always_disabled=!0,this.input.disabled=!0),this.input.addEventListener("change",function(b){b.preventDefault(),b.stopPropagation(),a.value=this.checked,a.onChange(!0)}),this.container.appendChild(this.control)},enable:function(){this.always_disabled||(this.input.disabled=!1),this._super()},disable:function(){this.input.disabled=!0,this._super()},destroy:function(){this.label&&this.label.parentNode&&this.label.parentNode.removeChild(this.label),this.description&&this.description.parentNode&&this.description.parentNode.removeChild(this.description),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this._super()}}),f.defaults.editors.arraySelectize=f.AbstractEditor.extend({build:function(){this.title=this.theme.getFormInputLabel(this.getTitle()),this.title_controls=this.theme.getHeaderButtonHolder(),this.title.appendChild(this.title_controls),this.error_holder=document.createElement("div"),this.schema.description&&(this.description=this.theme.getDescription(this.schema.description)),this.input=document.createElement("select"),this.input.setAttribute("multiple","multiple");var a=this.theme.getFormControl(this.title,this.input,this.description);this.container.appendChild(a),this.container.appendChild(this.error_holder),window.jQuery(this.input).selectize({delimiter:!1,createOnBlur:!0,create:!0})},postBuild:function(){var a=this;this.input.selectize.on("change",function(b){a.refreshValue(),a.onChange(!0)})},destroy:function(){this.empty(!0),this.title&&this.title.parentNode&&this.title.parentNode.removeChild(this.title),this.description&&this.description.parentNode&&this.description.parentNode.removeChild(this.description),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this._super()},empty:function(a){},setValue:function(a,b){var c=this;
// Update the array's value, adding/removing rows when necessary
...
// Show errors for this editor
if(d(a,function(a,d){d.path===b.path?c.push(d):e.push(d)}),this.error_holder)if(c.length){this.error_holder.innerHTML="",this.error_holder.style.display="",d(c,function(a,c){b.error_holder.appendChild(b.theme.getErrorMessage(c.message))})}else this.error_holder.style.display="none"}});var g=function(){var a=document.documentElement;return a.matches?"matches":a.webkitMatchesSelector?"webkitMatchesSelector":a.mozMatchesSelector?"mozMatchesSelector":a.msMatchesSelector?"msMatchesSelector":a.oMatchesSelector?"oMatchesSelector":void 0}();f.AbstractTheme=a.extend({getContainer:function(){return document.createElement("div")},getGridLayout:function(){var a=document.createElement("div");return a},getFloatRightLinkHolder:function(){var a=document.createElement("div");return a.style=a.style||{},a.style.cssFloat="right",a.style.marginLeft="10px",a},getModal:function(){var a=document.createElement("div");return a.style.backgroundColor="white",a.style.border="1px solid black",a.style.boxShadow="3px 3px black",a.style.position="absolute",a.style.zIndex="10",a.style.display="none",a},getModalList:function(){var a=document.createElement("div");return a.style.width="295px",a.style.maxHeight="160px",a.style.padding="5px 0",a.style.overflowY="auto",a.style.overflowX="hidden",a.style.paddingLeft="5px",a.setAttribute("class","property-selector"),a},getModalActionContent:function(){var a=document.createElement("div");return a.style.padding="5px",a},getGridContainer:function(){var a=document.createElement("div");return a},getGridRow:function(){var a=document.createElement("div");return a.className="row",a},getGridColumn:function(){var a=document.createElement("div");return a},setGridColumnSize:function(a,b){},getLink:function(a){var b=document.createElement("a");return b.setAttribute("href","#"),b.appendChild(document.createTextNode(a)),b},disableHeader:function(a){a.style.color="#ccc"},disableLabel:function(a){a&&(a.style.color="#ccc")},enableHeader:function(a){a.style.color=""},enableLabel:function(a){a&&(a.style.color="")},getFormInputLabel:function(a){var b=document.createElement("label");return b.appendChild(document.createTextNode(a)),b},getFileInputLabel:function(a){return this.getFormInputLabel()},getFileInputDecorator:function(){},getFileInputPreview:function(a){var b=document.createElement("p");b.style.right="10%",b.style.top="0",b.style.position="absolute",b.style.overflow="hidden";var c=document.createElement("a");c.setAttribute("target","_blank");var d=document.createElement("img");return d.style.verticalAlign="middle",d.style.maxHeight="40px",d.style.maxWidth="40px",this.setFileInputPreviewTooltip(d,a),a&&(c.setAttribute("href",a),d.setAttribute("src",a)),c.appendChild(d),b.appendChild(c),b},setFileInputPreviewTooltip:function(a,b){},getCheckboxLabel:function(a){var b=this.getFormInputLabel(a);return b.style.fontWeight="normal",b},getHeader:function(a){var b=document.createElement("h3");return"string"==typeof a?b.textContent=a:b.appendChild(a),b},getCheckbox:function(){var a=this.getFormInputField("checkbox");return a.style.display="inline-block",a.style.width="auto",a},getMultiCheckboxHolder:function(a,b,c){var d=document.createElement("div");b&&(b.style.display="block",d.appendChild(b));for(var e in a)a.hasOwnProperty(e)&&(a[e].style.display="inline-block",a[e].style.marginRight="20px",d.appendChild(a[e]));return c&&d.appendChild(c),d},getSelectInput:function(a){var b=document.createElement("select");return a&&this.setSelectOptions(b,a),b},getSwitcher:function(a){var b=this.getSelectInput(a);return b.style.backgroundColor="transparent",b.style.display="inline-block",b.style.fontStyle="italic",b.style.fontWeight="normal",b.style.height="auto",b.style.marginBottom=0,b.style.marginLeft="5px",b.style.padding="0 0 0 3px",b.style.width="auto",b},getSwitcherOptions:function(a){return a.getElementsByTagName("option")},setSwitcherOptions:function(a,b,c){this.setSelectOptions(a,b,c)},setSelectOptions:function(a,b,c){c=c||[],a.innerHTML="";for(var d=0;d<b.length;d++){var e=document.createElement("option");e.setAttribute("value",b[d]),e.textContent=c[d]||b[d],a.appendChild(e)}},setSelectEvents:function(a){},getSwitcherContainer:function(){return document.createElement("div")},setSwitcherEvents:function(a){},getTextareaInput:function(){var a=document.createElement("textarea");return a.style=a.style||{},a.style.width="100%",a.style.height="300px",a.style.boxSizing="border-box",a},getJsonEditorTextareaInput:function(){var a=this.getTextareaInput();return a.style.height="170px",a.style.width="300px",a},getRangeInput:function(a,b,c){var d=this.getFormInputField("range");return d.setAttribute("min",a),d.setAttribute("max",b),d.setAttribute("step",c),d},getFormInputField:function(a){var b=document.createElement("input");return b.setAttribute("type",a),b.style.width="220px",b.style.marginBottom="0",b.style.display="inline-block",b},getFileInputWrapper:function(){return document.createElement("div")},getPropertyNameInputField:function(){var a=this.getFormInputField("text");return a.style.width="auto",a.style.marginRight="5px",a},afterInputReady:function(a){},getFormControl:function(a,b,c){var d=document.createElement("div");return d.className="form-control",a&&d.appendChild(a),"checkbox"===b.type?a.insertBefore(b,a.firstChild):d.appendChild(b),c&&d.appendChild(c),d},getIndentedPanel:function(){var a=document.createElement("div");return a.style=a.style||{},a.style.paddingLeft="10px",a.style.marginLeft="10px",a.style.borderLeft="1px solid #ccc",a},getChildEditorHolder:function(){return document.createElement("div")},getDescription:function(a){var b=document.createElement("p");return b.innerHTML=a,b},getCheckboxDescription:function(a){return this.getDescription(a)},getFormInputDescription:function(a){return this.getDescription(a)},getHeaderButtonHolder:function(){return this.getButtonHolder()},getButtonHolder:function(){return document.createElement("div")},getButton:function(a,b,c){var d=document.createElement("button");return d.type="button",this.setButtonText(d,a,b,c),d},setButtonText:function(a,b,c,d){a.innerHTML="",c&&(a.appendChild(c),a.innerHTML+=" "),a.appendChild(document.createTextNode(b)),d&&a.setAttribute("title",d)},getTable:function(){return document.createElement("table")},getTableControls:function(){var a=document.createElement("div");return a.style.padding="5px",a},setTableButtonStyle:function(a){},getTableRow:function(){return document.createElement("tr")},getTableHead:function(){return document.createElement("thead")},getTableBody:function(){return document.createElement("tbody")},getTableHeaderCell:function(a){var b=document.createElement("th");return b.textContent=a,b},getTableCell:function(){var a=document.createElement("td");return a},getErrorMessage:function(a){var b=document.createElement("p");return b.style=b.style||{},b.style.color="red",b.appendChild(document.createTextNode(a)),b},addInputError:function(a,b,c){},removeInputError:function(a,b){},addTableRowError:function(a){},removeTableRowError:function(a){},getTabHolder:function(){var a=document.createElement("div");return a.innerHTML="<div style='float: left; width: 130px;' class='tabs'></div><div class='content' style='margin-left: 130px;'></div><div style='clear:both;'></div>",a},applyStyles:function(a,b){a.style=a.style||{};for(var c in b)b.hasOwnProperty(c)&&(a.style[c]=b[c])},closest:function(a,b){for(;a&&a!==document;){if(!a[g])return!1;if(a[g](b))return a;a=a.parentNode}return!1},getTab:function(a){var b=document.createElement("div");return b.appendChild(a),b.style=b.style||{},this.applyStyles(b,{border:"1px solid #ccc",borderWidth:"1px 0 1px 1px",textAlign:"center",lineHeight:"30px",borderRadius:"5px",borderBottomRightRadius:0,borderTopRightRadius:0,fontWeight:"bold",cursor:"pointer"}),b},getTabContentHolder:function(a){return a.children[1]},getTabContent:function(){return this.getIndentedPanel()},markTabContentActive:function(a){this.applyStyles(a,{display:""})},markTabContentInactive:function(a){this.applyStyles(a,{display:"none"})},markTabActive:function(a){this.applyStyles(a,{opacity:1,background:"white"})},markTabInactive:function(a){this.applyStyles(a,{opacity:.5,background:""})},addTab:function(a,b){a.children[0].appendChild(b)},getBlockLink:function(){var a=document.createElement("a");return a.style.display="block",a},getBlockLinkHolder:function(){var a=document.createElement("div");return a},getLinksHolder:function(){var a=document.createElement("div");return a},createMediaLink:function(a,b,c){a.appendChild(b),c.style.width="100%",a.appendChild(c)},createImageLink:function(a,b,c){a.appendChild(b),b.appendChild(c)}}),f.defaults.themes.bootstrap2=f.AbstractTheme.extend({getRangeInput:function(a,b,c){
...
// Icon only
c&&!b?(a.className+=" ui-button-icon-only",c.className+=" ui-button-icon-primary ui-icon-primary",a.appendChild(c)):c?(a.className+=" ui-button-text-icon-primary",c.className+=" ui-button-icon-primary ui-icon-primary",a.appendChild(c)):a.className+=" ui-button-text-only";var e=document.createElement("span");e.className="ui-button-text",e.textContent=b||d||".",a.appendChild(e),a.setAttribute("title",d)},getIndentedPanel:function(){var a=document.createElement("div");return a.className="ui-widget-content ui-corner-all",a.style.padding="1em 1.4em",a.style.marginBottom="20px",a},afterInputReady:function(a){a.controls||(a.controls=this.closest(a,".form-control"))},addInputError:function(a,b){a.controls&&(a.errmsg?a.errmsg.style.display="":(a.errmsg=document.createElement("div"),a.errmsg.className="ui-state-error",a.controls.appendChild(a.errmsg)),a.errmsg.textContent=b)},removeInputError:function(a){a.errmsg&&(a.errmsg.style.display="none")},markTabActive:function(a){a.className=a.className.replace(/\s*ui-widget-header/g,"")+" ui-state-active"},markTabInactive:function(a){a.className=a.className.replace(/\s*ui-state-active/g,"")+" ui-widget-header"}}),f.defaults.themes.barebones=f.AbstractTheme.extend({getFormInputLabel:function(a){var b=this._super(a);return b},getFormInputDescription:function(a){var b=this._super(a);return b},getIndentedPanel:function(){var a=this._super();return a},getChildEditorHolder:function(){var a=this._super();return a},getHeaderButtonHolder:function(){var a=this.getButtonHolder();return a},getTable:function(){var a=this._super();return a},addInputError:function(a,b){if(a.errmsg)a.errmsg.style.display="block";else{var c=this.closest(a,".form-control");a.errmsg=document.createElement("div"),a.errmsg.setAttribute("class","errmsg"),c.appendChild(a.errmsg)}a.errmsg.innerHTML="",a.errmsg.appendChild(document.createTextNode(b))},removeInputError:function(a){a.style.borderColor="",a.errmsg&&(a.errmsg.style.display="none")},getProgressBar:function(){var a=100,b=0,c=document.createElement("progress");return c.setAttribute("max",a),c.setAttribute("value",b),c},updateProgressBar:function(a,b){a&&a.setAttribute("value",b)},updateProgressBarUnknown:function(a){a&&a.removeAttribute("value")}}),f.defaults.themes.materialize=f.AbstractTheme.extend({getModal:function(){var a=document.createElement("div");return a.className="card mze-modal",a.style.position="absolute",a.style.zIndex="10",a.style.display="none",a},getModalList:function(){var a=document.createElement("div");return a.style.maxHeight="210px",a.style.overflow="auto",a.className="card-content mze-modal-content",a},getModalActionContent:function(){var a=document.createElement("div");return a.className="card-action mze-modal-action-content",a},getRangeInput:function(a,b,c){
// TODO: use bootstrap slider
return this._super(a,b,c)},getIndentedPanel:function(){var a=document.createElement("div");return a.className="card mze-indented-panel",a},getGridContainer:function(){var a=this._super();return a.className="card-content mze-grid-container",a},getGridRow:function(){var a=document.createElement("div");return a.className="row mze-grid-row",a},disableLabel:function(a){a&&(a.className="")},enableLabel:function(a){a&&(a.className="active")},getFormInputLabel:function(a){return this._super(a)},getFileInputLabel:function(a){var b=document.createElement("span");return b.appendChild(document.createTextNode(a)),b},getFileInputDecorator:function(){var a=document.createElement("div");a.className="file-path-wrapper";var b=document.createElement("input");return b.setAttribute("type","text"),b.className="file-path validate",a.appendChild(b),a},getFileInputPreview:function(a){var b=this._super(a);return b.className="preview",b},setFileInputPreviewTooltip:function(a,b){if(a.className="tooltipped",a.setAttribute("data-position","left"),a.setAttribute("data-delay","50"),a.setAttribute("data-html","true"),b){window.$(a).tooltip("remove");var c="<div><img class='tooltip-preview' src='"+b+"'/></div>";a.setAttribute("data-tooltip",c),window.$(a).tooltip()}},getHeader:function(a){var b=document.createElement("h4");return b.className="row mze-header","string"==typeof a?b.textContent=a:(a.className+=" col mze-header-text",b.appendChild(a)),b},setGridColumnSize:function(a,b){a.className=" mze-grid-column"},getSelectInput:function(a){var b=this._super(a);return b.className+=" mze-select-input",b},setSelectEvents:function(a){window.$(a.input).material_select(),window.$(a.input).on("change",function(b){b.preventDefault(),b.stopPropagation(),a.onInputChange()})},getSwitcherContainer:function(){var a=document.createElement("div");return a.className="mze-switcher-container",a},getSwitcher:function(a){var b=this.getSelectInput(a);return b.style.fontStyle="italic",b.className+=" mze-switcher",b},setSwitcherEvents:function(a){window.$(a.switcher).material_select(),window.$(a.switcher).on("change",function(b){b.preventDefault(),b.stopPropagation(),a.switchEditor(a.display_text.indexOf(this.value)),a.onChange(!0)})},getCheckbox:function(){var a=this.getFormInputField("checkbox");return a.className="validate mze-checkbox",a},getFormInputField:function(a){var b=document.createElement("input");return b.className="mze-input-field",b.setAttribute("type",a),b},afterInputReady:function(a){a.controlgroup||(a.controlgroup=this.closest(a,".input-field"))},getTextareaInput:function(){var a=document.createElement("textarea");return a.className="materialize-textarea mze-textarea-input",a},getJsonEditorTextareaInput:function(){var a=this._super();return a.className+=" mze-jeditor-textarea-input",a.style.overflow="auto",a.style.height="210px",a.style.width="100%",a},getFileInputWrapper:function(){var a=this._super();return a.className="file-field input-field",a},getDescription:function(a){var b=document.createElement("p");return b.className="light mze-description",b.style.margin="-15px 0 15px 0",b.textContent=a,b},getFormControl:function(a,b,c){var d,e=document.createElement("div");/* slugify text plus random number */
return a&&(d=a.innerText.toLowerCase().replace(/[^\w\s-]/g,"").replace(/[\s_-]+/g,"-").replace(/^-+|-+$/g,"")+"-"+Math.floor(1e4*Math.random()),a.setAttribute("for",d)),d&&b.setAttribute("id",d),"checkbox"===b.type?(e=document.createElement("p"),e.className+=" mze-checkbox-group",e.appendChild(b)):(e.className+="file"===b.type?" btn":" input-field mze-group",e.appendChild(b)),a&&e.appendChild(a),c&&e.appendChild(c),e},getButtonHolder:function(){var a=document.createElement("div");return a.className="col mze-button-holder",a.style.fontSize="14px",a},getButton:function(a,b,c){var d=this._super(a,b,c);return d.className+="waves-effect waves-light btn mze-button",d},getTable:function(){var a=document.createElement("table");return a.className="table bordered mze-table",a.style.padding="5px",a},getTableControls:function(){var a=document.createElement("div");return a.className="card-action mze-table-controls",a},setTableButtonStyle:function(a){a.className+=" right mze-table-button-style"},addInputError:function(a,b){a.controlgroup&&(a.className.indexOf("invalid")<0&&(a.className+=" invalid mze-input-error"),a.controlgroup.children[1].dataset.error=b)},removeInputError:function(a){a.controlgroup&&a.controlgroup.children.length>1&&delete a.controlgroup.children[1].dataset.error,a.className=a.className.replace(/\s?invalid/g,"")},getTabHolder:function(){var a=document.createElement("div");return a.className="row mze-tab-holder",a.innerHTML="<div class='col s12'><ul class='tabs'></ul></div>",a},getTab:function(a){var b=document.createElement("li");b.className="tab col s3 mze-tab";var c=document.createElement("a");return c.setAttribute("href","#"),c.appendChild(a),b.appendChild(c),b},getTabContentHolder:function(a){return a.children[0]},getTabContent:function(){var a=document.createElement("div");return a.className="col s12 mze-tab-content",a},markTabContentActive:function(a){a.className.indexOf("active")<0&&(a.className+=" active"),a.style.display=""},markTabContentInactive:function(a){a.className=a.className.replace(/\s?active/g,""),a.style.display="none"},markTabActive:function(a){a.className.indexOf("active")<0&&(a.className+=" active")},markTabInactive:function(a){a.className=a.className.replace(/\s?active/g,"")},addTab:function(a,b){a.children[0].children[0].appendChild(b)},getProgressBar:function(){var a=document.createElement("div");a.className="progress mze-progress-bar";var b=document.createElement("div");return b.className="determinate",b.style.width="0%",a.appendChild(b),a},updateProgressBar:function(a,b){a&&(a.firstChild.className="determinate",a.firstChild.style.width=b+"%")},updateProgressBarUnknown:function(a){a&&(a.firstChild.className="indeterminate",a.firstChild.style="")}}),f.AbstractIconLib=a.extend({mapping:{collapse:"",expand:"","delete":"",edit:"",add:"",cancel:"",save:"",moveup:"",movedown:""},icon_prefix:"",getIconClass:function(a){return this.mapping[a]?this.icon_prefix+this.mapping[a]:null},getIcon:function(a){var b=this.getIconClass(a);if(!b)return null;var c=document.createElement("i");return c.className=b,c}}),f.defaults.iconlibs.bootstrap2=f.AbstractIconLib.extend({mapping:{collapse:"chevron-down",expand:"chevron-up","delete":"trash",edit:"pencil",add:"plus",cancel:"ban-circle",save:"ok",moveup:"arrow-up",movedown:"arrow-down"},icon_prefix:"icon-"}),f.defaults.iconlibs.bootstrap3=f.AbstractIconLib.extend({mapping:{collapse:"chevron-down",expand:"chevron-right","delete":"remove",edit:"pencil",add:"plus",cancel:"floppy-remove",save:"floppy-saved",moveup:"arrow-up",movedown:"arrow-down"},icon_prefix:"glyphicon glyphicon-"}),f.defaults.iconlibs.fontawesome3=f.AbstractIconLib.extend({mapping:{collapse:"chevron-down",expand:"chevron-right","delete":"remove",edit:"pencil",add:"plus",cancel:"ban-circle",save:"save",moveup:"arrow-up",movedown:"arrow-down"},icon_prefix:"icon-"}),f.defaults.iconlibs.fontawesome4=f.AbstractIconLib.extend({mapping:{collapse:"caret-square-o-down",expand:"caret-square-o-right","delete":"times",edit:"pencil",add:"plus",cancel:"ban",save:"save",moveup:"arrow-up",movedown:"arrow-down"},icon_prefix:"fa fa-"}),f.defaults.iconlibs.foundation2=f.AbstractIconLib.extend({mapping:{collapse:"minus",expand:"plus","delete":"remove",edit:"edit",add:"add-doc",cancel:"error",save:"checkmark",moveup:"up-arrow",movedown:"down-arrow"},icon_prefix:"foundicon-"}),f.defaults.iconlibs.foundation3=f.AbstractIconLib.extend({mapping:{collapse:"minus",expand:"plus","delete":"x",edit:"pencil",add:"page-add",cancel:"x-circle",save:"save",moveup:"arrow-up",movedown:"arrow-down"},icon_prefix:"fi-"}),f.defaults.iconlibs.jqueryui=f.AbstractIconLib.extend({mapping:{collapse:"triangle-1-s",expand:"triangle-1-e","delete":"trash",edit:"pencil",add:"plusthick",cancel:"closethick",save:"disk",moveup:"arrowthick-1-n",movedown:"arrowthick-1-s"},icon_prefix:"ui-icon ui-icon-"}),f.defaults.iconlibs.materialize=f.AbstractIconLib.extend({mapping:{collapse:"keyboard_arrow_up",expand:"keyboard_arrow_down","delete":"delete",edit:"mode_edit",add:"add",cancel:"undo",save:"save",moveup:"arrow_upward",movedown:"arrow_downward",upload:"cloud_upload",clean_upload:"highlight_off"},icon_prefix:"",getIcon:function(a){var b=this.getIconClass(a);if(!b)return null;var c=document.createElement("i");c.className="material-icons left";var d=document.createTextNode(b);return c.appendChild(d),c}}),f.defaults.templates["default"]=function(){return{compile:function(a){var b=a.match(/{{\s*([a-zA-Z0-9\-_ \.]+)\s*}}/g),c=b&&b.length;
...
f.defaults.default_language="en",f.defaults.language=f.defaults.default_language,
...
if(a.oneOf||a.anyOf)return"multiple"}),f.defaults.languages.en={/**
...
button_upload:"Upload",/**
   ...
   */
button_clear_upload:"Clear"},f.defaults.languages.es={/**
   * When a property is not set
   */
